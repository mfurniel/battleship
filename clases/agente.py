...
from busquedas.heat_map import busqueda_heat_map
from busquedas.heat_map import gen_prob_map
...
class Agente:
    def __init__(self, nombre):
        ...
        # columna-fila; lo vemos como coordenada x y
        self.coordenada_hunted = (0, 0)
        self.direccion_target = 'none'
        self.casillas_encontradas = []
    ...
    def respuesta(self, rival, coordenada_x, coordenada_y):
        ...
        if (rival.tableroPropio[coordenada_x][coordenada_y] == 1):
            self.casillas_encontradas.append((coordenada_x, coordenada_y))
            return True
        return 0
    ...
    def heat_map(self, rival):
        busqueda_heat_map(self, rival)
